...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _googleLogin() async {
    ...
    try {
      ...
      // Try to login with Google email and auto-generated password
      // Must match the password used during Google signup
      final result = await ApiService.login(
        email: email,
      ...
      if (result['success']) {
        ...
        setState(() {
          final message = result['message'] ?? 'Google login failed';
          // Provide helpful message if account doesn't exist
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Google Sign In Button (disabled on web - use mobile app)
                if (!kIsWeb)
                  SizedBox(
                    width: double.infinity,
